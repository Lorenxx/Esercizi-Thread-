/*
  Copyright (C) 2019 Lorenco Malaj
...
/**
 * Questo programma produrrà numeri tra 0 e uno specicifico valore e dirà se il 
 * 
 * 
...
public class ParDis extends Thread{
   ...
   * Costruttore.
   * 
   * @param finale è il numero massimo
  ...
  */
  ...
  /**
   * Nel main vengono lanciati due diversi Thread che contano, rispettivamente,
   * uno il numero di valori pari e l'altro i valori dispari.
   * 
   * @param args 
   */
